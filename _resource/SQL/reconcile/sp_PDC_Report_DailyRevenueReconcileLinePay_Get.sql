...
-- =============================================
CREATE PROCEDURE [dbo].[sp_PDC_Report_DailyRevenueReconcileLinePay_Get]
	...
	--//***** Begin Syntax *****//--
		...
		FROM (
			SELECT	 b.ERP_ID AS ERPID
					...
					-- EOD ==================================================================
					,ISNULL(eod.LinePay, 0) AS EOD
					-- EOD ==================================================================

					-- DailyRevenue =========================================================
					,ISNULL(dr.LinePay, 0) AS DailyRevenue
					-- DailyRevenue =========================================================
			...
			FROM tb_daily_revenue AS dr
				...
				LEFT JOIN tb_reconcile_summary_master AS rsm
					ON dr.BranchID = rsm.branch_id AND dr.ReportDate = rsm.report_date AND rsm.[type_id] = 'L'
